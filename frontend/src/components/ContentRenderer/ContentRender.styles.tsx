...
export const Subtitle = styled.h2<{ $theme: any }>`
  color: ${({ $theme }) => $theme.colors.primary};
  margin-top: 24px;
  margin-bottom: 12px;
  font-size: 20px;
...
export const Paragraph = styled.p<{ $theme: any }>`
  margin-bottom: 12px;
  color: ${({ $theme }) => $theme.colors.text};
  font-size: 16px;
`
...
export const ImageContainer = styled.figure<{ $theme: any }>`
  margin: 24px 0;
  text-align: center;
...
export const Caption = styled.figcaption<{ $theme: any }>`
  margin-top: 12px;
  font-size: 14px;
...
export const HighlightedParagraph = styled(Paragraph)<{ $active: boolean; $theme: any }>`
...
export const HighlightedSubtitle = styled(Subtitle)<{ $active: boolean; $theme: any }>`
  background: ${({ $active, $theme }) =>
    $active ? $theme.colors.primaryLight : 'transparent'};
  border-radius: ${({ $active }) => ($active ? '8px' : '0')};
  padding: ${({ $active }) => ($active ? '4px 8px' : '0')};
...
export const HighlightedListItem = styled(ListItem)<{ $active: boolean; $theme: any }>`
  background: ${({ $active, $theme }) =>
    $active ? $theme.colors.primaryLight : 'transparent'};
