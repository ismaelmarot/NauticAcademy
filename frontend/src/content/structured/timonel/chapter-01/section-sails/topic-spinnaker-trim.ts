...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'title', text: 'Identificación de los Lados' },
    ...
    { type: 'title', text: 'Izado del Spinnaker' },
    ...
    { type: 'title', text: 'Trimado para Obtener Fuerza (Viento Suave)' },
    ...
    { type: 'title', text: 'Posición de la Vela Mayor' },
    ...
    { type: 'title', text: 'Arriado del Spinnaker' },
