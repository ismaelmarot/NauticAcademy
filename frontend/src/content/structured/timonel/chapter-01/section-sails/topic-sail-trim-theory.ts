...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Fuerza Aerodinámica' },
    ...
    { type: 'subtitle', text: 'Efectos de la Escora' },
    ...
    { type: 'subtitle', text: 'Fuerza Hidrodinámica' },
    ...
    { type: 'subtitle', text: 'Descomposición de las Fuerzas' },
