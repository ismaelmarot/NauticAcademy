...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'El Nudo Llano' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_llano.png', alt: 'Nudo llano', caption: 'Cómo armar el nudo llano' },
    ...
    { type: 'subtitle', text: 'El Nudo Vuelta de Escota' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_vuelta_de_escota.png', alt: 'Nudo vuelta de escota', caption: 'Nudo de vuelta de escota o empalme' },
    ...
    { type: 'subtitle', text: 'Nudo Lasca u Ocho' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_ocho.png', alt: 'Nudo lasca u ocho', caption: 'Nudo en forma de ocho' },
    ...
    { type: 'subtitle', text: 'Nudo de Fraile' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_fraile.png', alt: 'Nudo de fraile', caption: 'Nudo vuelta de guirnalda' },
    ...
    { type: 'subtitle', text: 'Nudo Ballestrinque' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_ballestrinque.png', alt: 'Nudo ballestrinque', caption: 'Nudo del barquero' },
    ...
    { type: 'subtitle', text: 'Nudo Margarita' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_margarita.png', alt: 'Nudo margarita', caption: 'Nudo de lazo para emergencias' },
    ...
    { type: 'subtitle', text: 'Nudo Corredizo' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_corredizo.png', alt: 'Nudo corredizo', caption: 'Nudo de lazo simple' },
    { type: 'paragraph', text: 'El nudo corredizo o nudo de lazo simple se utiliza para enlazar un objeto y azocarlo.' },

    { type: 'subtitle', text: 'Nudo As de Guía' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_as_de_guia.png', alt: 'Nudo as de guía', caption: 'Nudo más importante para navegantes' },
    ...
    { type: 'subtitle', text: 'Nudo de Vuelta de Cornamusa' },
    { type: 'image', src: '/images/content/timonel/chapter-01/section-cabuyeria/knots/nudo_vuelta_de_cornamuza.png', alt: 'Nudo de vuelta de cornamusa', caption: 'Nudo para cornamusas y bitas' },
