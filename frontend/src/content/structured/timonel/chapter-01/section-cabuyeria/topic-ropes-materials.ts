...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'title', text: 'Tipos de Cabos' },
    ...
    { type: 'title', text: 'Materiales y Atributos' },
    ...
    { type: 'title', text: 'Fibras Sintéticas' },
    ...
    { type: 'title', text: 'Características' },
    ...
    { type: 'title', text: 'Cuidado y Protección de los Cabos' },
