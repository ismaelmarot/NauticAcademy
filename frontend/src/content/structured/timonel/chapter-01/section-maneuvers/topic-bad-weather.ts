...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Decisión de Navegar o No' },
    ...
    { type: 'subtitle', text: 'Preparación del Barco' },
    ...
    { type: 'subtitle', text: 'Preparación de Tripulación' },
    ...
    { type: 'subtitle', text: 'Planeamiento Navegación' },
    ...
    { type: 'subtitle', text: 'En la Tormenta' },
    ...
    { type: 'subtitle', text: 'Técnicas de Supervivencia' },
    ...
    { type: 'subtitle', text: 'Anclas de Mar' },
    ...
    { type: 'subtitle', text: 'Otros Dispositivos' },
