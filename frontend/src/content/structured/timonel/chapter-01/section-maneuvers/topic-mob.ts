...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Reacción de la Tripulación' },
    ...
    { type: 'subtitle', text: 'Reacción del Náufrago' },
    ...
    { type: 'subtitle', text: 'Métodos a Motor: Círculo de Evolución' },
    ...
    { type: 'subtitle', text: 'Métodos a Motor: Butákov' },
    ...
    { type: 'subtitle', text: 'Métodos a Motor: Tiempos Iguales' },
    ...
    { type: 'subtitle', text: 'Métodos a Motor: Marcha Atrás' },
    ...
    { type: 'subtitle', text: 'Métodos a Vela: Maniobra del Ocho' },
    ...
    { type: 'subtitle', text: 'Métodos a Vela: Maniobra del Cero' },
    ...
    { type: 'subtitle', text: 'Métodos a Vela: Quick-Stop (Parada Rápida)' },
