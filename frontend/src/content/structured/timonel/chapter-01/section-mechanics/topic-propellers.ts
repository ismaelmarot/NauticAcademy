...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Características de una Hélice' },
    ...
    { type: 'subtitle', text: 'Cantidad de Palas' },
    ...
    { type: 'subtitle', text: 'Velocidad Máxima de Rotación' },
    ...
    { type: 'subtitle', text: 'Fuerzas Laterales y Resbalamiento' },
    ...
    { type: 'subtitle', text: 'Tipos de Hélices' },
    ...
    { type: 'subtitle', text: 'Sistemas de Transmisión' },
    ...
    { type: 'subtitle', text: 'Sistemas de Propulsión por Chorro de Agua (Waterjets)' },
