...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Tipos de Motores' },
    ...
    { type: 'subtitle', text: 'Ciclo de Trabajo de un Motor a Nafta de Cuatro Tiempos' },
    ...
    { type: 'subtitle', text: 'Ciclo de Trabajo de un Motor Diésel de Cuatro Tiempos' },
    ...
    { type: 'subtitle', text: 'Ciclo de Trabajo de un Motor a Nafta de Dos Tiempos' },
    ...
    { type: 'subtitle', text: 'Diferencias entre un Motor Diésel y uno de Nafta' },
    ...
    { type: 'subtitle', text: 'Sistema de Refrigeración' },
    ...
    { type: 'subtitle', text: 'Motores Internos y Fuera de Borda' },
    ...
    { type: 'subtitle', text: 'Motores Eléctricos' },
