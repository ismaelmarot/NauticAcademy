...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'title', text: 'Cómo Funciona una Batería' },
    ...
    { type: 'title', text: 'Componentes de una Batería' },
    ...
    { type: 'title', text: 'Corriente Continua vs Alterna' },
    ...
    { type: 'title', text: 'Tipos de Baterías según Régimen de Descarga' },
    ...
    { type: 'title', text: 'Tipos de Baterías en Náutica Recreativa' },
    ...
    { type: 'title', text: 'Conexión de Bancos de Baterías' },
    ...
    { type: 'title', text: 'Cálculo del Banco de Baterías de Servicio' },
    ...
    { type: 'title', text: 'Cantidad Recomendada de Bancos' },
    ...
    { type: 'title', text: 'Recarga de las Baterías' },
