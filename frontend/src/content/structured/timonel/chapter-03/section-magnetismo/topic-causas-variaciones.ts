...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'title', text: 'El Campo Magnético de la Tierra' },
    ...
    { type: 'title', text: 'Los Polos Magnéticos' },
    ...
    { type: 'title', text: 'Meridianos Magnéticos, Declinación e Inclinación' },
    ...
    { type: 'title', text: 'Variaciones del Campo Magnético Terrestre' },
