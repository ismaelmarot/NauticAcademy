...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Definición del Desvío del Compás' },
    ...
    { type: 'subtitle', text: 'Cómo Estimar el Desvío del Compás' },
    ...
    { type: 'subtitle', text: 'Ejemplo de Cálculo del Desvío' },
    ...
    { type: 'subtitle', text: 'Método Alternativo Simplificado' },
    ...
    { type: 'subtitle', text: 'Comentarios y Buenas Prácticas' },
    { type: 'list', items: [
