...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'La Declinación Magnética' },
    ...
    { type: 'subtitle', text: 'La Rosa de Declinación Magnética en las Cartas Náuticas' },
    ...
    { type: 'subtitle', text: 'Procedimiento para Calcular la Declinación Magnética para un Mes y Año Dado' },
    ...
    { type: 'subtitle', text: 'Consideraciones Prácticas' },
    { type: 'list', items: [
