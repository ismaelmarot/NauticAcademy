...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'La Marcación' },
    ...
    { type: 'subtitle', text: 'La Enfilación (Transit o Range)' },
    ...
    { type: 'subtitle', text: 'Arco de Distancia' },
    ...
    { type: 'subtitle', text: 'Arco de distancia por visibilidad' },
    { type: 'list', items: [
    ...
    { type: 'subtitle', text: 'Arco de distancia por altura angular' },
    { type: 'list', items: [
    ...
    { type: 'subtitle', text: 'Otras referencias de posición' },
    ...
    { type: 'subtitle', text: 'Conversión Mv = Mc + Dm + δ aplicada a demoras' },
    ...
    { type: 'subtitle', text: 'El triángulo de posición' },
