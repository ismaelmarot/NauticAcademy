...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Las Reglas Paralelas' },
    ...
    { type: 'subtitle', text: 'Buenas Prácticas para el Uso de las Reglas Paralelas' },
    { type: 'list', items: [
    ...
    { type: 'subtitle', text: 'Alternativas a las Reglas Paralelas' },
    ...
    { type: 'subtitle', text: 'El Talco o Regla de Navegación' },
    ...
    { type: 'subtitle', text: 'Buenas Prácticas para el Uso del Talco' },
    { type: 'list', items: [
    ...
    { type: 'subtitle', text: 'El Compás de Puntas Secas y el de Dibujo' },
    ...
    { type: 'subtitle', text: 'Buenas Prácticas para el Uso del Compás' },
    { type: 'list', items: [
    ...
    { type: 'subtitle', text: 'La Lupa o Lupa con Base' },
    ...
    { type: 'subtitle', text: 'Lápices y Gomas de Borrar' },
