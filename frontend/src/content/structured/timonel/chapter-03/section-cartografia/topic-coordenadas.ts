...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Tipos de Coordenadas' },
    ...
    { type: 'subtitle', text: 'Los Círculos Máximos y Menores' },
    ...
    { type: 'subtitle', text: 'Las Coordenadas Geográficas' },
    ...
    { type: 'subtitle', text: 'Los Paralelos y la Latitud' },
    ...
    { type: 'subtitle', text: 'Los Meridianos y la Longitud' },
    ...
    { type: 'subtitle', text: 'Las Escalas de Latitud y Longitud' },
    ...
    { type: 'subtitle', text: 'La Escala de Distancias' },
    ...
    { type: 'subtitle', text: 'El Meridiano de Greenwich como Referencia' },
