...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Jurisdicciones' },
    ...
    { type: 'subtitle', text: 'Navegación y Practicaje' },
    ...
    { type: 'subtitle', text: 'Pesca y Recursos' },
