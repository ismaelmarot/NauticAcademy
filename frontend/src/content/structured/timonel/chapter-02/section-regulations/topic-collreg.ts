...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Estructura del RIPA' },
    ...
    { type: 'subtitle', text: 'Parte A: Generalidades' },
    ...
    { type: 'subtitle', text: 'Parte B: Reglas de Rumbo y Gobierno' },
    ...
    { type: 'subtitle', text: 'Parte C: Luces y Marcas' },
    ...
    { type: 'subtitle', text: 'Parte D: Ayudas Acústicas' },
    ...
    { type: 'subtitle', text: 'Parte E: Exenciones' },
