...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Actividad frontal' },
    ...
    { type: 'subtitle', text: 'Frente Frío' },
    ...
    { type: 'subtitle', text: 'Frente Cálido' },
    ...
    { type: 'subtitle', text: 'Frente Ocluido' },
    ...
    { type: 'subtitle', text: 'Frente Estacionario' },
    ...
    { type: 'subtitle', text: 'Etapas de formación de frentes (Modelo Shapiro-Keyser, hemisferio sur)' },
