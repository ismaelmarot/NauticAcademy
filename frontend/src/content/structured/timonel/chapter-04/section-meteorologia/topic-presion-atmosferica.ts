...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'title', text: 'Unidades de Medida e Instrumentos' },
    ...
    { type: 'title', text: 'Isobaras e Isohipsas' },
    ...
    { type: 'title', text: 'Presión Atmosférica Media' },
    ...
    { type: 'title', text: 'Interpretación de las Isóbaras' },
    ...
    { type: 'title', text: 'Rangos Típicos de Presión' },
    { type: 'title', text: 'Anticiclones Semipermanentes' },
    ...
    { type: 'title', text: 'Anticiclones Migratorios' },
    ...
    { type: 'title', text: 'Bajas Presiones Frontales' },
