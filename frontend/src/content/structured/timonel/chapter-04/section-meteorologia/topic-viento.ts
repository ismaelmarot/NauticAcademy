...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'subtitle', text: 'Factores que Definen la Dirección y Fuerza del Viento' },
    { type: 'subtitle', text: 'Gradiente de Presión' },
    ...
    { type: 'subtitle', text: 'Efecto de Coriolis' },
    ...
    { type: 'subtitle', text: 'Rozamiento Superficial' },
    ...
    { type: 'subtitle', text: 'Fuerzas Centrípeta y Centrífuga' },
    ...
    { type: 'subtitle', text: 'Viento Geostrófico' },
    ...
    { type: 'subtitle', text: 'Borneos, Rotaciones y Ráfagas' },
    { type: 'list', items: [
