...
export const topic: Topic = {
  ...
  content: [
    ...
    { type: 'title', text: 'Imágenes satelitales' },
    ...
    { type: 'title', text: 'Cartas de Pilotaje (Pilot Charts)' },
    ...
    { type: 'title', text: 'Internet y aplicaciones' },
    ...
    { type: 'title', text: 'Fuentes de datos GRIB' },
